...
mais relevância e conexão.

## Design Empático e Design Thinking
...
Outra ideia importante são as **"três lentes" do Design Thinking**: a boa solução
é aquela que fica no meio do que é **desejável** (o que as pessoas querem),
**viável** (se compensa para o negócio) e **factível** (se é tecnicamente
possível construir).
...
- **Bússola da Formação Empática** — orienta os designers a aplicar empatia de
  ...
  aumentar a consciência do papel do designer e a qualidade das soluções.

## Benefícios e limitações

Entre os **benefícios**, o design empático leva a soluções mais humanas e
centradas no usuário, gera maior satisfação e engajamento, inclui diferentes
realidades e necessidades, e cria uma conexão emocional que ajuda na fidelidade
do cliente.
...
Um ponto central é que **UX não é só usabilidade**: é a experiência emocional
completa. O design empático é uma base fundamental para o design centrado no
usuário, dá suporte a públicos vulneráveis e minoritários, e ainda funciona como
diferencial competitivo, porque usuários que se conectam emocionalmente tendem a
ser mais fiéis.

Um caso de uso que ilustra bem isso são os **Guias de Bairro do Airbnb**: a
empresa percebeu a dificuldade dos turistas em encontrar experiências autênticas
e criou guias com recomendações de moradores locais (atividades culturais,
restaurantes, atrações), resultando numa experiência mais genuína e conectada ao
destino.
...
- INTERACTION DESIGN FOUNDATION. *Design Thinking*. Disponível em:
